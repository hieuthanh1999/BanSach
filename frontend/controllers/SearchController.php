<?php 
	...
	class SearchController extends Controller{
		...
		public function price(){
			...
			$this->loadView("SearchPriceView.php",["data"=>$data,"numPage"=>$numPage,"key"=>$key,"fromPrice"=>$toPrice,"toPrice"=>$toPrice]);
		}
		//ajax search
