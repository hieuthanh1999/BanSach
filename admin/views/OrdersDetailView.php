...
<div class="col-md-12">   
    <div class="panel panel-default" style="margin-bottom:5px;">
        <div class="panel-heading" style=" display: flex; justify-content: space-between;"><div>Thông tin đơn hàng</div>
        <form method="post" action="generate-pdf.php">
    
        <input type="hidden" value="<?php echo $id;?>"  name="id" id="name">
        
        <button formtarget="_blank" >Generate PDF</button>
    </form></div>
